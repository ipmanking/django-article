...
SECRET_KEY = '1wkf0rkc2gzmss$)r+xgp4adu(h+c!m^tdg007rl8vj$rq%5xs'
...
MEDIA_URL="/media/"
MEDIA_ROOT = os.path.join(BASE_DIR,"template").replace("\\","/")


STATIC_ROOT = os.path.join(BASE_DIR,"template/static").replace("\\","/")
